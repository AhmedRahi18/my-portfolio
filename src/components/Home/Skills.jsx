        ...
        <div id="skills" className="mt-32">
            ...
            <div className="text-white flex justify-around pb-20" data-aos="fade-up">
                <div>
                    ...
                    <ProgressBar  bgColor="#329"className="md:w-96 w-44" completed={90} />
                    <p className="my-2">CSS</p>
                    <ProgressBar  bgColor="#329" className="md:w-96 w-44" completed={85} />
                    <p className="my-2">BootStrap</p>
                    <ProgressBar  bgColor="#329" className="md:w-96 w-44" completed={85} />
                    <p className="my-2">Tailwind</p>
                    <ProgressBar  bgColor="#329" className="md:w-96 w-44" completed={85} />
                    <p className="my-2">JavaScript</p>
                    <ProgressBar  bgColor="#329" className="md:w-96 w-44" completed={75} />
                ...
                <p className="my-2">Firebase</p>
                    ...
                    <ProgressBar  bgColor="#329" className="md:w-96 w-44" completed={70} />
